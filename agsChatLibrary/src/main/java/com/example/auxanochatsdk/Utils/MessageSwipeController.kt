...
import com.example.auxanochatsdk.ui.ChatListFragment.Companion.isSwipeMessage
        ...
        if (showing) {
            if (replyButtonProgress < 1.0f) {
                ...
                if (replyButtonProgress > 1.0f) {
                    ...
                    Log.e("checkSwipe", "if showing: ")
                } else {
                    Log.e("checkSwipe", "else showing: ")
                    isSwipeMessage = true
                    mView.invalidate()
                }
            }
           ...
           // isSwipeMessage = false
            ...
            if (replyButtonProgress > 0.0f) {
                ...
                if (replyButtonProgress < 0.1f) {
                    replyButtonProgress = 0f
                    Log.e("checkSwipe", "if in else: ")
                } else {
                    mView.invalidate()
                    Log.e("checkSwipe", "else else: ")
                }
            }
        }
        val alpha: Int
